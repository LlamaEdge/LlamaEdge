...
impl ChatCompletionToolCallMessage {
...
#[test]
fn test_chat_serialize_tool_call_message() {
    let message = ChatCompletionToolCallMessage {
        ...
        tool_calls: Some(vec![ToolCall {
            ...
            function: Function {
                ...
                arguments: "{\"location\":\"Beijing\",\"unit\":\"celsius\"}".to_string(),
            },
        }]),
        name: None,
    };
